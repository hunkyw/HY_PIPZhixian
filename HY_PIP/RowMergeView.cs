...
namespace HY_PIP
{
    ...
    {
        private static Color gridHeadBackColor = Color.FromArgb(70, 60, 55);
        private static Color gridColumnBackColor = Color.FromArgb(217, 210, 206);
        private Font bigFont = new Font("微软雅黑", 14, FontStyle.Regular);
